...
import com.example.kotlin_singelactivityexample.databinding.FragmentThirdBinding
...
class ThirdFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding?.apply {
            ...
            root.setOnClickListener { Navigation.findNavController(binding!!.root).navigate(R.id.action_thirdFragment_to_firstFragment) }

            // Получение данных через ViewModel
            viewModel.getSelectedItem().observe(this@ThirdFragment) {
                fieldText.text = it
            }
        }
